...
imageParam){var width=arguments.length>1&&arguments[1]!==undefined?arguments[1]:0;var height=arguments.length>2&&arguments[2]!==undefined?arguments[2]:0;var options=arguments.length>3&&arguments[3]!==undefined?arguments[3]:{};
...
return image;
}},{key:'_getHost',value:function _getHost(
...
}},{key:'_getExt',value:function _getExt(
...
return'';
}}]);return CropManager;}();exports.default=
